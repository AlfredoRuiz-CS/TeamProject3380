  ...
  return (
    <>
      <div className="flex h-screen flex-col overflow-y-hidden bg-bgwhite bg-gradient-to-b from-logoblue via-bgwhite to-bgwhite font-poppins text-black">
        <Header />
        {/* Page Content */}
        <div className=" flex h-screen flex-col items-center text-pretty bg-transparent pt-[10rem] text-center">
          ...
          {/* Buttons */}
          <div className="flex flex-row gap-6 mb-12 mt-6">
          <Button
              asChild
              variant="outline"
        ...
        <div className="mx-[15rem] flex flex-row justify-around gap-10 pb-10">
          {/* Bus Card */}
          <div className="flex h-[23rem] w-[45rem] flex-col rounded-2xl bg-[#d9d9d9]">
